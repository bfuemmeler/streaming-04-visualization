"""src/streaming/kafke_producer_fuemmeler.py - Kafka producer example.
...
MESSAGE_COUNT: typing.Final[int] = int(msg_count)
MESSAGE_INTERVAL_SECONDS: typing.Final[float] = float(msg_interval_seconds)

# === DECLARE CONSTANT PATHS ===

ROOT_DIR: typing.Final[pathlib.Path] = pathlib.Path.cwd()
DATA_DIR: typing.Final[pathlib.Path] = ROOT_DIR / "data"
OUTPUT_DIR: typing.Final[pathlib.Path] = DATA_DIR / "output"

SALES_CSV: typing.Final[pathlib.Path] = DATA_DIR / "sales.csv"
REGIONS_CSV: typing.Final[pathlib.Path] = DATA_DIR / "regions.csv"
PRODUCTS_CSV: typing.Final[pathlib.Path] = DATA_DIR / "products.csv"
REJECTED_SALES_CSV: typing.Final[pathlib.Path] = (
    OUTPUT_DIR / "producer_rejected_sales.csv"
)
