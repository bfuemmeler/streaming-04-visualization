"""src/streaming/visualizations/live_visualizations_fuemmeler.py.
...
def update_live_chart(
    *,
    ...
    # Create a new y value from the "subtotal" field in the message,
    # which contains the sale subtotal for that message.
